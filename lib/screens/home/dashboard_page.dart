...
//     } else if (_selectedPeriod == 'Bulan Kemarin') {
//       _startDate = DateTime(now.year, now.month - 1, 1);
//       _endDate = DateTime(now.year, now.month, 0, 23, 59, 59);
//     } else if (_selectedPeriod == 'Bulan Depan') {
//       _startDate = DateTime(now.year, now.month + 1, 1);
//       _endDate = DateTime(now.year, now.month + 2, 0, 23, 59, 59);
//     }
//   }
...
//         userId: userId,
//         onTransactionAdded: () {
//           // Tidak perlu setState karena StreamBuilder akan update otomatis
//         },
//       ),
//     );
//   }
...
//     return Scaffold(
//       // AppBar sekarang berada di dalam DashboardPage
//       appBar: AppBar(
//         title: Text(
//           "Hai, $userName!",
...
//         elevation: 0,
//       ),
//       // Tombol FAB juga pindah ke sini
...
// // --- SEMUA WIDGET PENDUKUNG ADA DI SINI ---
...
//     final incomeFormatted = currencyFormatter.format(totalIncome);
//     final expenseFormatted = currencyFormatter.format(totalExpense);
//     final differenceFormatted =
...
//                 isExpanded: true,
//                 items: <String>['Bulan Kemarin', 'Bulan Ini', 'Bulan Depan']
...
//           ),
//           const SizedBox(height: 24),
//           if (pieDataMap.isNotEmpty &&
//               pieDataMap.keys.first != "Belum ada data")
//             PieChart(
//               dataMap: pieDataMap,
...
//                   amount:
//                       "${transaction.isIncome ? '+' : '-'} $amountFormatted",
